...
4. **여유는 초과분에만 적용한다.** all-light 는 정의상 1.0배라 초과할 수 없으므로
   ...
   손해 봅니다.
5. **점수 예측은 2PL 문항반응모형.** `p_m = sigmoid(a_m · (θ(x) − b_m))`,
...
| --- | ---: | ---: | ---: | --- |
| Fast | 0.648580 | 1.099132 / 1.25 | 87.9% | 통과 |
| Balanced | 0.690909 | 1.728181 / 2.0 | 86.4% | 통과 |
| Premium | 0.717330 | 3.020222 / 4.0 | 75.5% | 통과 |
| **최종** | **0.681903** | | | |
...
네이티브 실행보다 **느린 쪽**입니다. 공식 환경의 최종 판정은 운영자 실행을 따릅니다.
